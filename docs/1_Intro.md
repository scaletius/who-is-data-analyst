...
Возможно, ты уже погружался в какие-то вводные материалы и думаешь, что анализ данных — это про числа. В реальности аналитик может столкнуться с данными любого типа:
