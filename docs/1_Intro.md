...
Обычно на этом уровне уже есть понимание, чем данные могут помочь бизнесу, но нет понимания необходимости или бюджета на выделение аналитики в отдельное направление. Благодаря этому из состояния ведения всей аналитики в Excel достаточно просто выйти на нормальный уровень.

### Уровень 4. Крепкий середнячок

В штатном расписании есть как минимум один полноценный аналитик.

### Уровень 5. Отлично, продолжаем в том же духе

Небольшая команда аналитики
...
Как я уже обозначил ранее, в зависимости от размеров бизнеса перед аналитиками могут стоять совершенно разные задачи. В какой-то степени это диктует подход к построению команды, но кроме размера и бюджета фирмы на состав команды влияют и 